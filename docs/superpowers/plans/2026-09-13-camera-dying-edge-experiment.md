...
- [x] **Step 3: Commit and push the evidence record**
...
- [x] **Step 4: Update Drive and Notion**
...
- [x] **Step 1: Write the failing accounting assertions**
...
- [x] **Step 3: Implement terminal accounting without changing attribution policy**
...
- [x] **Step 4: Run all focused verification**
...
- [x] **Step 5: Run until an accept or the round bound**
