...
class SpectatorAIIntegrationTests(unittest.TestCase):
    ...
    def test_spectator_hud_uses_screen_primitives_and_preserves_result_banner(self):
        ...
        self.assertIn("function SpectatorArena:ObserveCameraEventExecution", source)
        self.assertIn("CAMERA_EVENT_CAMERA_SAMPLE", source)
        self.assertIn("CAMERA_EVENT_MOVEMENT_ONSET", source)
        self.assertIn("CAMERA_EVENT_ARRIVED", source)
        self.assertIn("CameraEventObservationArrivalTolerance", source)
        self.assertIn("CameraMan:GetOffset(screen)", source)
        self.assertIn("CameraMan:GetScrollTarget(screen)", source)
        self.assertIn("distanceToTarget", source)
